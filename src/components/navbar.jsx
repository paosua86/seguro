...
const Navbar = () => {
//Declarar las constantes para cada sección
const servicesSection = useRef()
//Declarar las constantes que harán el scroll
const scrollToservices = () => services.current.scrollIntoView()
    ...
    return (
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed inset-x-0 top-0 z-50">
        <div className="max-w-full flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/seguro/" className="flex items-center">
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-language-select">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <a className='nav-item' onClick={scrollToservices}><span>Servicio/</span></a>
              </li>
              <li>
